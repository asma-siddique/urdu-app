...
class VocabularyBankScreen extends StatelessWidget {
  ...
  static const List<_VocabCat> _cats = [
    ...
    _VocabCat(
        'Urdu Poetic Terms', Icons.auto_stories_rounded, Color(0xFF7C3AED)),
    _VocabCat(
        'Essential Urdu Phrases', Icons.chat_bubble_rounded, Color(0xFF059669)),
    ...
    _VocabCat(
        'Political Terms', Icons.account_balance_rounded, Color(0xFF1E3A5F)),
        ...
        Padding(
          ...
          child:
            ...
            Row(children: [
              ...
              GestureDetector(
                onTap: () =>
                    TtsService.instance.speak('Vocabulary Bank. ذخیرہ الفاظ'),
                child: Container(
                    width: 36,
                    height: 36,
                    decoration: BoxDecoration(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
              builder: (_) => VocabDetailScreen(title: cat.label))),
      child: Container(
        ...
        child: Row(children: [
          Container(
              ...
              child:
                  Center(child: Icon(cat.icon, color: Colors.white, size: 26))),
          ...
          Expanded(
              child: Column(
                ...
                Text('Tap to explore words',
                    style: TextStyle(
                        fontSize: 11, color: cat.color.withOpacity(0.75))),
              ])),
          const SizedBox(width: 10),
          Icon(Icons.chevron_right_rounded,
              color: cat.color.withOpacity(0.6), size: 24),
        ]),
      ),
    );
  }
...
class _VocabDetailState extends State<VocabDetailScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final words = _data[widget.title] ??
        [const _Word('جلد آ رہا ہے', 'Coming soon', 'Coming soon', '🚧')];
    return Directionality(
      textDirection: TextDirection.ltr,
      child: Scaffold(
        backgroundColor: _kBg,
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: Center(
              child: Text(word.emoji, style: const TextStyle(fontSize: 26))),
        ),
        const SizedBox(width: 12),
        Expanded(
            child: Column(
        ...
        GestureDetector(
          onTap: () =>
              TtsService.instance.speak('${word.roman}. ${word.english}'),
          child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10)),
              child:
                  const Icon(Icons.volume_up_rounded, color: _kTeal, size: 20)),
        ),
      ]),
    );
  }
